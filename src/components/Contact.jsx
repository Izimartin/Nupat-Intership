			...
			<div className='container w-container'>
						...
						<div
							...
							<div className='header-link-card'>
								<div className='header-icon-wrap'>
									<img
										src='../assets.website-files.com/63a43a1633ad3e2a969a6958/63a4416ecc9a622b68fc40b2_mail-icon.png'
										loading='lazy'
										alt='Mail Icon'
									/>
								</div>
							...
							<div className='header-link-card'>
								<div className='header-icon-wrap'>
									<img
										src='../assets.website-files.com/63a43a1633ad3e2a969a6958/63a4417904383d0d539ac57b_Phone-icon.png'
										loading='lazy'
										alt='Phone Icon'
									/>
								</div>
							...
							<div className='header-link-card'>
								<div className='header-icon-wrap'>
									<img
										src='../assets.website-files.com/63a43a1633ad3e2a969a6958/63a43d2bd004d0a80d725af2_clock-icon.png'
										loading='lazy'
										alt='Clock Icon'
									/>
								</div>
				...
				<div className='w-layout-grid partners-grid'>
					<div
						...
						/>
						<img
							src='../assets.website-files.com/63a43a1633ad3e2a969a6958/63ce0f62b45e86924ec54dec_client-bg-image-1.jpg'
							loading='lazy'
							srcSet='
					...
					<div
						...
						/>
						<img
							src='../assets.website-files.com/63a43a1633ad3e2a969a6958/63ce113d70e27851ea41786d_client-bg-image-2.jpg'
							loading='lazy'
							width={300}
							sizes='(max-width: 479px) 100vw, (max-width: 991px) 95vw, 299px'
							alt='Partner Background Image'
					...
					<div
						...
						/>
						<img
							src='../assets.website-files.com/63a43a1633ad3e2a969a6958/63ce114cf329ee4be2282070_client-bg-image-3.jpg'
							loading='lazy'
							width={300}
							sizes='(max-width: 479px) 100vw, (max-width: 991px) 95vw, 299px'
							alt='Partner Background Image'
					...
					<div
						...
						/>
						<img
							src='../assets.website-files.com/63a43a1633ad3e2a969a6958/63ce11590760e7f86b546dc5_client-bg-image-4.jpg'
							loading='lazy'
							width={300}
							sizes='(max-width: 479px) 100vw, (max-width: 991px) 95vw, 299px'
							alt='Partner Background Image'
