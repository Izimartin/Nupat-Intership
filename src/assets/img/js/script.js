		...
		function _t(t) {
			...
			if (
				(D
					...
					: (N = C = l({ id: I, selector: T, selectorGuids: O })),
				o && x)
			) {
				var M = a && (C || !0 === x) ? [a] : d(P);
				if (C) {
		...
		function kt(t) {
			...
			e.actionItems.forEach(function (t) {
				...
				(e = (0, E.isPluginType)(i)
					? (0, E.clearPlugin)(i)
					: Ft({ effect: Gt, actionTypeId: i, elementApi: r })),
	...
	function (t, e, n) {
		...
		function f(t, e, n, r) {
			...
			(m.build = function () {
				return (
					m.destroy(),
					((f = { html: n(e.documentElement), empty: n() }).arrowLeft = F(
					...
					f.container.on("click", D("view"), I).on("dragstart", D("img"), A),
							...
							N(
								...
								function (r) {
									if (t === o) {
										var i,
											a,
											s = F("figure", "figure").append(P(r, "image")),
											p = F("frame").append(s),
											h = F("view")
												.prop("tabIndex", 0)
										...
										e.html &&
											...
											s.append(P(i, "embed"))),
											e.caption &&
												s.append(F("caption", "figcaption").text(e.caption)),
											f.spinner.before(h),
											a || E();
									}
									function E() {
	...
	function (t, e, n) {
		...
		r.define(
			...
			(t.exports = function (t, e) {
				...
				function y() {
					(n = l.find(p)).length &&
						(n.each(I), c || (_(), r.resize.on(b), r.redraw.on(s.redraw)));
				}
				function _() {
				...
				function D(e, n) {
					...
					if (e.index !== e.previous) {
						if (
							...
							return (
								(w = "opacity " + O + "ms " + _),
								f(h).set({ visibility: "" }).add(w).start({ opacity: 0 }),
								void f(v)
	...
	events: {
		...
		"e-127": {
			...
			target: {
				...
				originalId:
					"63a57e9a6bba275742f829bf|5986b915-ed61-138e-97b4-1397719334fd",
				appliesTo: "CLASS",
			},
			targets: [
				{
		...
		"e-159": {
			...
			target: {
				...
				originalId:
					"63a57e9a6bba275742f829bf|061c2828-995f-0fab-d200-8f7a4cde8424",
				appliesTo: "CLASS",
			},
			targets: [
				{
		...
		"e-165": {
			...
			target: {
				selector: ".about-list",
				originalId:
					"63a57e9a6bba275742f829bf|fb8c18d4-b4fe-3a0f-2be3-a59fd8b65807",
				appliesTo: "CLASS",
			},
			targets: [
				{
		...
		"e-169": {
			...
			target: {
				selector: ".work-card",
				originalId:
					"63a57e9a6bba275742f829bf|d9a5ad58-057c-a763-bbe6-c17c9cb18fce",
				appliesTo: "CLASS",
			},
			targets: [
				{
		...
		"e-171": {
			...
			action: {
				...
				actionTypeId: "SLIDE_EFFECT",
				instant: false,
				config: { actionListId: "slideInRight", autoStopEventId: "e-172" },
			},
			mediaQueries: ["main", "medium", "small", "tiny"],
			target: {
				selector: ".testimonial-slider",
				originalId:
					"63a57e9a6bba275742f829bf|bb697a6d-5bda-f196-47b5-f5a7c2ed64a2",
				appliesTo: "CLASS",
			},
			targets: [
				{
		...
		"e-173": {
			...
			action: {
				...
				instant: false,
				config: { actionListId: "growIn", autoStopEventId: "e-174" },
			},
			mediaQueries: ["main", "medium", "small", "tiny"],
			target: {
		...
		"e-175": {
			...
			action: {
				...
				actionTypeId: "GROW_EFFECT",
				instant: false,
				config: { actionListId: "growIn", autoStopEventId: "e-176" },
			},
			mediaQueries: ["main", "medium", "small", "tiny"],
			target: {
				selector: ".features-points-wrap",
				originalId:
					"63a57e9a6bba275742f829bf|16003282-e667-4114-88fc-64755df23930",
				appliesTo: "CLASS",
			},
			targets: [
				{
		...
		"e-177": {
			...
			target: {
				selector: ".team-card",
				originalId:
					"63a57e9a6bba275742f829bf|5437c918-4aee-e803-ed09-ea60a5464a22",
				appliesTo: "CLASS",
			},
			targets: [
				{
		...
		"e-179": {
			...
			target: {
				...
				originalId:
					"63a57e9a6bba275742f829bf|5e3ffe26-ca4f-e6ee-6d06-46db6141838f",
				appliesTo: "CLASS",
			},
			targets: [
				{
		...
		"e-203": {
			...
			target: {
				...
				originalId:
					"63abd7b28605626777532b54|ebeb8b7f-77c3-0e03-06d6-b4e438d41fa6",
				appliesTo: "CLASS",
			},
			targets: [
				{
		...
		"e-219": {
			...
			target: {
				...
				originalId:
					"63ac0a69acaa431d0248e9b3|b8968a17-6e1e-7077-25a3-06ef94d2cf60",
				appliesTo: "CLASS",
			},
			targets: [
				{
		...
		"e-221": {
			...
			target: {
				...
				originalId:
					"63ac0a69acaa431d0248e9b3|e6c9c52b-15b0-9074-952b-57376574938e",
				appliesTo: "CLASS",
			},
			targets: [
				{
		...
		"e-231": {
			...
			target: {
				...
				originalId:
					"63ad140255e11ac96151f40f|14fba6d4-6cf2-8f6d-19cc-b6975ea28168",
				appliesTo: "CLASS",
			},
			targets: [
				{
		...
		"e-237": {
			...
			action: {
				...
				actionTypeId: "GROW_EFFECT",
				instant: false,
				config: { actionListId: "growIn", autoStopEventId: "e-238" },
			},
			mediaQueries: ["main", "medium", "small", "tiny"],
			target: {
		...
		"e-251": {
			...
			target: {
				...
				originalId:
					"63a43a1633ad3e6a5e9a6959|aadf8a77-7f63-0aba-3937-93d75f04b3e6",
				appliesTo: "CLASS",
			},
			targets: [
				{
		...
		"e-253": {
			...
			action: {
				...
				actionTypeId: "GROW_EFFECT",
				instant: false,
				config: { actionListId: "growIn", autoStopEventId: "e-254" },
			},
			mediaQueries: ["main", "medium", "small", "tiny"],
			target: {
		...
		"e-255": {
			...
			action: {
				...
				actionTypeId: "GROW_EFFECT",
				instant: false,
				config: { actionListId: "growIn", autoStopEventId: "e-256" },
			},
			mediaQueries: ["main", "medium", "small", "tiny"],
			target: {
		...
		"e-263": {
			...
			action: {
				...
				actionTypeId: "GROW_EFFECT",
				instant: false,
				config: { actionListId: "growIn", autoStopEventId: "e-264" },
			},
			mediaQueries: ["main", "medium", "small", "tiny"],
			target: {
		...
		"e-265": {
			...
			action: {
				...
				actionTypeId: "GROW_EFFECT",
				instant: false,
				config: { actionListId: "growIn", autoStopEventId: "e-266" },
			},
			mediaQueries: ["main", "medium", "small", "tiny"],
			target: {
					...
					actionItems: [
						...
						},
						{
							...
							config: {
								...
								filters: [
									{ type: "invert", filterId: "ea34", value: 0, unit: "%" },
								],
							},
						},
					],
					...
					actionItems: [
						{
							...
							config: {
								...
								filters: [
									{ type: "invert", filterId: "e91e", value: 100, unit: "%" },
								],
							},
						},
						{
					...
					actionItems: [
						...
						},
						{
							...
							config: {
								...
								filters: [
									{ type: "invert", filterId: "688e", value: 0, unit: "%" },
								],
							},
						},
					],
					...
					actionItems: [
						...
						},
						{
							...
							config: {
								...
								filters: [
									{ type: "invert", filterId: "4672", value: 100, unit: "%" },
								],
							},
						},
					],
